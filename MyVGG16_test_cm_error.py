...
# 加载上次结束训练时的权重
model.load_weights(r"doorModels\cp-327-0.048-0.984-1.000-0.485-0.878-0.969.h5")  # 1.3698-0.6014-0.7758
...
# cmPath = r"numpy"
# os.makedirs(cmPath, exist_ok=True)
# cmPath = cmPath+myPath+r'_cm.npy'
# np.save(cmPath, cm)
